       ...
       file-control.
           select d assign to TRANFILE organization indexed access dynamic record key k file status f1.
           select o assign to TRANDUMP organization sequential file status f2.
       data division.
       file section.
       fd d. 01 d-rec. 05 k pic x(16). 05 filler pic x(334).
       fd o. 01 o-rec pic x(350).
