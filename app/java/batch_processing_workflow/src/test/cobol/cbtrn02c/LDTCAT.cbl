       ...
       file-control.
           select s assign to SRCTCAT organization line sequential file status f1.
           select d assign to TCATBALF organization indexed access dynamic record key k file status f2.
       data division.
       file section.
